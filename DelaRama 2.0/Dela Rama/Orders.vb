...
Public Class frmOrders
    ...
    Private Sub txtStock_KeyUp(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtQuantity.KeyUp, txtStock.KeyUp
    ...
    Private Sub txtChange_KeyUp(sender As Object, e As System.Windows.Forms.KeyEventArgs) Handles txtCash.KeyUp, txtTotalPayment.KeyUp
        gago()
    End Sub
    Private Sub gago()
        txtChange.Text = Val(txtTotalPayment.Text) - Val(txtCash.Text)
    End Sub


    Private Sub Numbers_only(ByVal sender As System.Object, ByVal e As System.Windows.Forms.KeyPressEventArgs) Handles txtQuantity.KeyPress, txtCash.KeyPress
    ...
    Private Sub btnDelete_Click(sender As System.Object, e As System.EventArgs) Handles btnDelete.Click
        Dim result As DialogResult _
          = MessageBox.Show("Do you want to delete Order ?", _
        ...
        If result = DialogResult.Yes Then
            ...
            Try
                ...
                sql = "DELETE FROM Orders WHERE OrderID='" & txtOrderID.Text.Trim() & "'"
    ...
    Private Sub btnNewOrder_Click(sender As System.Object, e As System.EventArgs) Handles btnNewOrder.Click
        Dim result As DialogResult _
           = MessageBox.Show("Do you  to procceed to new Order ?", _
             "Save", MessageBoxButtons.YesNo, _
             MessageBoxIcon.Question)
        If result = DialogResult.Yes Then
    ...
    Private Sub btnReciept_Click(sender As System.Object, e As System.EventArgs) Handles btnReciept.Click
        Try
            ...
            sql = "INSERT  INTO Receipt (Date,Total) VALUES ('" & DateTimePicker1.Value() & "','" & txtTotalPayment.Text.Trim() & "')"
