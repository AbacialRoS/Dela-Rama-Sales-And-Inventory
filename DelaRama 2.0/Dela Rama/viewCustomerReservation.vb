...
Public Class viewCustomerReservation
    ...
    Dim sql As String
    Private Sub viewCustomerReservation_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub save()
        ...
        If rd.Read Then
            ...
            frmReservation.txtCustomerName.Text = Name
            frmReservation.txtAddress.Text = add
            frmReservation.txtCotanct.Text = con
