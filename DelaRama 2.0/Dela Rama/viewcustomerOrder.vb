...
Public Class viewcustomerOrder
    ...
    Dim sql As String
    Private Sub viewcustomerOrder_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
    ...
    Public Sub save()
        ...
        If rd.Read Then
            ...
            frmOrders.txtCustomerName.Text = Name
